    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
              onPressed: () {
                SSHClientProvider client =
                    Provider.of<SSHClientProvider>(context, listen: false);
                openBalloon('Vivek', 'hi', 'hu', 5, 'description', 'fdsaf',
                    'fdsaf', client);
              },
  ...
  _sendMessage(String text) async {
    try {
      ...
      setState(() {
        ...
        openBalloon('Vivek', 'hi', 'hu', 5, responseMessage.text, 'fdsaf',
            'fdsaf', sshClientProvider);
      });
